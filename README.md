...
$$\nabla \times \mathbf{H} = 0\hspace{.5mm}, \qquad \nabla \cdot  \mathbf{B} = 0\hspace{.5mm},$$
...
$$\nabla^2\varphi = \nabla \cdot \mathbf{M}\hspace{.5mm}.$$
Its solution, based on the assumed uniform magnetization $\mathbf{M}\_{\star}$, formally reads:
$$\varphi(\mathbf{P}) = \frac{1}{4\pi}\int\_{\mathrm{S}}  \frac{\mathbf{M}\_{\star} \cdot \hat{\mathbf{n}}}{||\mathbf{P}-\mathbf{P}'||} \hspace{.5mm} \mathrm{d} \mathrm{S}^\prime,$$
